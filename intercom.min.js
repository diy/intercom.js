...
this.lastMessage=a;this.bindings=[];this.receivedIDs={};this.previousValues={};a=function(){c._onStorageEvent.apply(c,arguments)};window.attachEvent?document.attachEvent("onstorage",a):window.addEventListener("storage",a,!1)};d.prototype._localStorageChanged=function(c,a){if(c&&c.key)return c.key===a;var b=f.getItem(a);if(b===this.previousValues[a])return!1;this.previousValues[a]=b;return!0};d.prototype._transaction=function(c){var a=this,b=!1,e=!1,o=null,d=function(){if(!b){var g=(new Date).getTime(),
q=parseInt(f.getItem(l)||0);q&&1E3>g-q?(e||(a._on("storage",d),e=!0),o=window.setTimeout(d,20)):(b=!0,f.setItem(l,g),c(),e&&a._off("storage",d),o&&window.clearTimeout(o),f.removeItem(l))}};d()};d.prototype._cleanup_emit=h.throttle(100,function(){this._transaction(function(){for(var c=(new Date).getTime()-5E4,a=0,b=JSON.parse(f.getItem(j)||"[]"),e=b.length-1;0<=e;e--)b[e].timestamp<c&&(b.splice(e,1),a++);0<a&&f.setItem(j,JSON.stringify(b))})});d.prototype._cleanup_once=h.throttle(100,function(){this._transaction(function(){var c=
(new Date).getTime()-36E5,a=0,b=JSON.parse(f.getItem(k)||"{}"),e;for(e in b)b.hasOwnProperty(e)&&b[e]<c&&(delete b[e],a++);0<a&&f.setItem(k,JSON.stringify(b))})});d.prototype._onStorageEvent=function(c){var c=c||window.event,a=this;this._localStorageChanged(c,j)&&this._transaction(function(){for(var c=(new Date).getTime(),e=f.getItem(j),e=JSON.parse(e||"[]"),d=0;d<e.length;d++)if(e[d].origin!==a.origin&&!(e[d].timestamp<a.lastMessage)){if(e[d].id){if(a.receivedIDs.hasOwnProperty(e[d].id))continue;
