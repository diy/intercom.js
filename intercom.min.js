...
var n=g.createInterface("_handlers");g.prototype._on=n.on;g.prototype._off=n.off;g.prototype._trigger=n.trigger;var p=g.createInterface("handlers");g.prototype.on=function(){p.on.apply(this,arguments);Array.prototype.unshift.call(arguments,"on");this._trigger.apply(this,arguments)};g.prototype.off=p.off;g.prototype.trigger=p.trigger;var e=window.localStorage;"undefined"===typeof e&&(e={getItem:function(){},setItem:function(){},removeItem:function(){}});var i={},h=function(){return(65536*(1+Math.random())|
...
b(),window.setTimeout(function(){c._cleanup_once()},50))})}};i.extend(d.prototype,g.prototype);d.bindings=[];d.supported="undefined"!==typeof e;var j="intercom",k="intercom_once",l="intercom_lock";d.destroy=function(){e.removeItem(l);e.removeItem(j);e.removeItem(k)};var q=null;d.getInstance=function(){q||(q=new d);return q};var r=function(a,b,c){b=i.extend({id:null,send:!0,receive:!0},b);if(b.receive){var d=[],e=function(e){-1===d.indexOf(e)&&(d.push(e),a.on(e,function(a){var d="function"===typeof b.id?
b.id(e,a):null,f="function"===typeof b.receive?b.receive(e,a):!0;(f||"boolean"!==typeof f)&&c._emit(e,a,d)}))},g;for(g in c.handlers)for(var h=0;h<c.handlers[g].length;h++)e(g,c.handlers[g][h]);c._on("on",e)}b.send&&c._on("emit",function(c,d){var e="function"===typeof b.send?b.send(c,d):!0;(e||"boolean"!==typeof e)&&a.emit(c,d)})};r.factory=function(a,b,c){return"undefined"===typeof a.socket?!1:new r(a,b,c)};d.bindings.push(r);return d}();
